...
barHeight    = '36px'
labelColor   = '#fff'
usedColor    = '#525252' #'#d7051d'
freeColor    = 'rgba(#000, .5)' #'rgba(255,255,255,0.1)' # '#525252'
bgColor      = '#fff'
borderRadius = '5px'
bgOpacity    =  0.4 #0.9
...
style: """
  ...
  .bar
    ...
    &.used
      ...
      background-image: repeating-linear-gradient(-45deg, rgba(#c00, .5), rgba(#c00, .5) 1px, transparent 2px, transparent 4px)
